...
from main.routes.logistics.cancel import cancel_namespace
from main.routes.logistics.cancellation_reasons import cancellation_reasons_namespace
from main.routes.logistics.confirm import confirm_namespace
from main.routes.logistics.init import init_namespace
...
from main.routes.logistics.rating import rating_namespace
from main.routes.response import response_namespace
from main.routes.logistics.search import search_namespace
# from main.routes.logistics.search import logistics_search_namespace
from main.routes.logistics.select import select_namespace
from main.routes.logistics.status import status_namespace
from main.routes.logistics.support import support_namespace
from main.routes.logistics.track import track_namespace
from main.routes.logistics.update import update_namespace
from main.utils.schema_utils import transform_json_schema_error
from main.routes.logistics.issue import issue_namespace
# from main.routes.logistics.issue import logistics_issue_namespace
from main.routes.logistics.issue_status import issue_status_namespace
